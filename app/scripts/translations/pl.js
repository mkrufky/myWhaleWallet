...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyWhaleWalletCX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz MyWhaleWalletponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz MyWhaleWalletw [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz MyWhaleWalletponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz MyWhaleWalletw [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://www.mywhalewallet.com/#help) po instrukcje. ',
...
HELP_0_Desc_1               : 'MyWhaleWallet daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_4CX_Title              : '4)Jak wysłać Ether używając MyWhaleWalletCX? ',
...
HELP_5_Title                : '5) Jak uruchomić MyWhaleWalletoffline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić MyWhaleWalletlokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyWhaleWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium MyWhaleWalletna przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
...
HELP_8_Desc_1               : 'MyWhaleWallet nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Ethereum. ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyWhaleWalletCX. W ten sposób, jeżeli cokolwiek stanie się MyWhaleWalletCX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyWhaleWalletCX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyWhaleWalletdo geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z MyWhaleWalletv2+.... ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - MyWhaleWalletCX ',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [https://www.mywhalewallet.com](https://www.mywhalewallet.com). ',
