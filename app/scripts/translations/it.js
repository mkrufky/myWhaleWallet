...
tx_FoundOnChain_3           : '**Se non vedi errori, la transazione è stata inviata correttamente.** I tuoi ETH o i tuoi token sono dove li hai inviati. Se non vedi questi ETH o token nell\'altro portafoglio / nel conto della piattaforma di scambio, e se sono passate più di 24 ore dall\'invio, [contatta quel servizio esterno](https://mywhalewallet.groovehq.com/knowledge_base/topics/i-have-a-question-but-its-not-about-myetherwallet-dot-com-what-do-i-do). Invia loro il *link* alla transazione e chiedi, cortesemente, di controllare la tua situazione.',
...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite MyWhaleWallet(o Mist, Geth, Parity e altri client.) ',
...
TXFEE_Desc                  : 'La commissione transazione si paga ai *miner* perché includano la transazione in un blocco. Si calcola come `limite gas` * `prezzo gas`. [Puoi calcolare la conversione GWEI -> ETH qui](https://www.mywhalewallet.com/helpers.html)',
...
sidebar_donation            : 'MyWhaleWallet è un servizio gratuito e open-source votato alla tua privacy e sicurezza. Più donazioni riceviamo, più tempo dedichiamo a creare nuove funzionalità, considerare i tuoi commenti, e darti ciò che vuoi. Siamo solo due persone che provano a cambiare il mondo. Ci aiuti? ',
sidebar_donate              : 'Dona ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con MyWhaleWalletCX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',
...
ADD_Ledger_0a               : 'Devi accedere a MyWhaleWallettramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri MyWhaleWalletutilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Riapri MyWhaleWalletsu una connessione sicura (SSL) ',
ADD_DigitalBitbox_0b        : 'Riapri MyWhaleWalletutilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyEtherWallet.com. Puoi [scaricare il repository di MyWhaleWalleted eseguirlo in locale](https://github.com/kvhnuke/etherwallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
ERROR_35                    : 'L\'indirizzo inserito non ha un checksum. <a href="https://mywhalewallet.groovehq.com/knowledge_base/topics/not-checksummed-shows-when-i-enter-an-address" target="_blank" rel="noopener"> Ulteriori informazioni</a>', // 35
...
TranslatorName_1            : '[ugilio](https://www.mywhalewallet.com/?gaslimit=21000&to=0x07932bc1c68c8ff188f4225e892178ab6d8c4eaa&value=1.0#send-transaction) ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando MyWhaleWalletCX? ',
...
HELP_8_Desc_1               : 'MyWhaleWallet non è un portafoglio web. Non hai un login e niente viene mai salvato nei nostri server. È semplicemente un\'interfaccia che ti consente di interagire con la *blockchain*. ',
HELP_8_Desc_2               : 'Se MyEtherWallet.com va giù, dovrai trovare un altro modo (come geth o Ethereum Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da MyWhaleWalletperché non si trovano in MyEtherWallet. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
...
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù MyWhaleWalletè prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se MyWhaleWalletCX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con MyWhaleWalletCX. In questo modo se succede qualcosa a MyWhaleWalletCX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione MyWhaleWalletCX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con MyWhaleWalletin geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Geth/Mist generato da MyWhaleWalletv2+.... ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. MyEtherWallet.com non lo fa. La generazione di numeri casuali di MyWhaleWalletè sicura? ',
...
HELP_SecCX_Title            : 'Sicurezza - MyWhaleWalletCX ',
...
HELP_Sec_Desc_4             : 'Controlla l\'URL -- Questo sito viene servito attraverso GitHub e puoi vederne il codice sorgente qui: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) su [https://www.mywhalewallet.com](https://www.mywhalewallet.com). ',
