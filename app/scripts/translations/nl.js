...
tx_Summary                  : 'Ten tijden van hoog transactie volume (zoals tijdens ICOs) kunnen transacties voor uren, zo niet dagen, "pending" blijven. Deze tool heeft als doel om je de mogelijkheid te geven om deze TXs op te sporen en ze te "annuleren" / vervangen. ** Dit is niet typisch iets wat je kunt doen. Je zou er niet op moeten vertrouwen dat dit werkt & het kan alleen werken als de TX Pools vol zitten. [Lees hier meer over deze tool.](https://mywhalewallet.groovehq.com/knowledge_base/topics/how-can-i-check-on-the-status-of-my-transaction-can-i-cancel-override-overwrite-replace-or-do-anything-once-a-transaction-has-been-sent)**',
...
tx_FoundOnChain_3           : '**Als je geen enkele foutmelding ziet is je transactie met succes verzonden.** Je ETH of Tokens zijn waar je ze naar verzonden hebt. Als je je verzonden ETH of Tokens niet gecrediteerd ziet in je andere wallet / exchange account, en het is inmiddels al 24+ uur geleden sinds je de transactie verzonden hebt, neem dan [contact op met die service](https://mywhalewallet.groovehq.com/knowledge_base/topics/i-have-a-question-but-its-not-about-myetherwallet-dot-com-what-do-i-do). Geef ze de *link* naar je transactie en vraag ze op je allerliefste manier om naar je situatie te kijken.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via MyWhaleWallet(of Mist, Geth, Parity en andere wallet clients.) ',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> ETH converteren](https://www.mywhalewallet.com/helpers.html)',
...
/* Footer */
FOOTER_1                    : 'Een gratis, open source, client-side interface om Ethereum wallets te genereren &amp; meer. Wissel op een gemakkelijke &amp; veilige manier informatie uit met de WhaleCoin blockchain. Dubbel-check de URL/link ( .com ) alvorens je wallet te openen.',
...
ADD_Ledger_0a               : 'Her-open MyWhaleWalletmet een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open MyWhaleWalletdoor gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open MyWhaleWalletmet een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open MyWhaleWalletdoor gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyWhaleWalletCX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://www.mywhalewallet.com/#help) voor instructies. ',
...
ERROR_35                    : 'Input adres is niet ge-checksummed. <a href="https://mywhalewallet.groovehq.com/knowledge_base/topics/not-checksummed-shows-when-i-enter-an-address" target="_blank" rel="noopener"> Meer info</a>', // 35
...
TranslatorName_1            : '[h3ll0fr13nd](https://www.mywhalewallet.com/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Zie je dat er iets mist? Of heb je een andere vraag? [Neem contact met ons op](mailto:support@mywhalewallet.com), en we zullen niet alleen je vraag beantwoorden, maar ook deze help pagina bijwerken zodat deze nog nuttiger wordt voor toekomstige gebruikers! ',
...
HELP_4CX_Title              : '4) Hoe verzend ik Ether met MyWhaleWalletCX? ',
...
HELP_8_Desc_1               : 'MyWhaleWallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als MyEtherWallet.com er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je Ether uit MyWhaleWallethalen omdat het niet in MyWhaleWalletzit. Je Ether zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyWhaleWallet wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van MyWhaleWalletv2+.... ',
...
HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. MyEtherWallet.com doet dit niet. Is de wikkeleurigheid (random number generation) van MyWhaleWalletwel veilig? ',
...
HELP_SecCX_Title            : 'Beveiliging - MyWhaleWalletCX ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://www.mywhalewallet.com](https://www.mywhalewallet.com). ',
