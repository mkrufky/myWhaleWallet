...
MYWAL_Content_3             : 'Если Вы планируете в будущем использовать этот кошелёк в MyWhaleWalletCX, Вам надо будет вручную заново добавить его, указав закрытый ключ или файл JSON и пароль. ',
...
ADD_Ledger_0a               : 'Перезапустите MyWhaleWalletчерез безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите MyWhaleWalletс браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите MyWhaleWalletчерез безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите MyWhaleWalletс браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
TranslatorName_1            : '[Михаил Владимиров](https://www.mywhalewallet.com/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
