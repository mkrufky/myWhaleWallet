...
var sendTxCtrl = function($scope, $sce, walletService) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://www.mywhalewallet.com?txHash=" + resp.data + "#check-tx-status";
                ...
                var emailBtn = '<a class="btn btn-xs btn-info " href="mailto:support@mywhalewallet.com?Subject=Issue%20regarding%20my%20TX%20&Body=' + emailBody + '" target="_blank" rel="noopener">Confused? Email Us.</a>';
