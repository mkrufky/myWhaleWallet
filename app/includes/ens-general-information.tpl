<article class="block" ng-hide="hideEnsInfoPanel">
  ...
  <div class="cont-md">
    ...
    <h4> What is the process like? </h4>
      ...
      <hr />
      <h6><a href="https://mywhalewallet.groovehq.com/knowledge_base/categories/ens" target="_blank" rel="noopener">Help Center: ENS</a>
      &nbsp;&middot;&nbsp;
      <a href="https://mywhalewallet.groovehq.com/knowledge_base/topics/debugging-a-bad-instruction-reveal" target="_blank" rel="noopener">Debugging a [BAD INSTRUCTION] Reveal</a></h6>
