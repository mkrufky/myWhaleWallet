  ...
  <section class="modal-dialog">
    <section class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="small"><a href="https://mywhalewallet.groovehq.com/knowledge_base/topics/how-can-i-connect-to-a-custom-node" target="_blank" rel="noopener"> Instructions can be found here </a></p>

        <div ng-show="browserProtocol=='https:'" class="alert alert-danger small" translate="NODE_Warning">
          Your node must be HTTPS in order to connect to it via MyWhaleWallet.com. You can [download the MyWhaleWallet repo & run it locally](https://github.com/WhaleCoinOrg/myWhaleWallet) to connect to your local node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)</a>.
        </div>
