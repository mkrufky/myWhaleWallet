<main class="tab-pane active" ng-if="globalService.currentTab==globalService.tabs.addWallet.id" ng-controller='addWalletCtrl'  ng-cloak>
  ...
  <article class="row" ng-if="showAddWallet">
    ...
    <div class="col-sm-4">
      ...
      <ul class="account-info">
        <li><a href="https://explorer.whalecoin.org/#/address/{{wallet.getAddressString()}}" target="_blank" rel="noopener">https://explorer.whalecoin.org/#/address/ {{wallet.getAddressString()}}</a></li>
      </ul>
    </div>
